...
void twirl() {
    LF.spinFor(2, sec, 100, voltageUnits::mV); // spins for two secs
    LB.spinFor(2, sec, 100, voltageUnits::mV);

    RF.spinFor(2, sec, -100, voltageUnits::mV); // spins the right side's motors in the opposite direction    
    RB.spinFor(2, sec, -100, voltageUnits::mV); // (hence the negative velocity)
